...
function Search() {
  ...
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[#071530] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      {/* left side */}
      <div className="left flex-1">
        <motion.img
          ...
          alt=""
          className="absolute top-[19rem] w-[90rem]"
        />
        <motion.img
